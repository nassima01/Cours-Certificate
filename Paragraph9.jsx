      ...
      <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg p-6 rounded-2xl m-3 text-center">
          ...
          <div className="mt-10">
            <div className="mt-8">
              ...
              <p className="text-gray-400">les considérations liées au déploiement des modèles</p>
              <div className="mx-auto" >
                  <YouTube videoId="SHyFjJ-tIJE" opts={videoOptions} onReady={onReady} />
             </div>       
              <p className="mt-8 text-sm text-gray-400">
              les considérations liées au déploiement des modèles, y compris la gestion des mises à jour, la surveillance continue des performances, et la prise en compte des contraintes matérielles pour assurer une intégration réussie dans des environnements de production.
              </p>
